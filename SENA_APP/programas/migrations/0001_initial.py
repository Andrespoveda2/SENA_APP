    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel_formacion', models.CharField(choices=[('AUX', 'Auxiliar'), ('OPE', 'Operario'), ('TEC', 'Tecnico'), ('TEC', 'Técnico'), ('TGL', 'Tecnólogo'), ('ESP', 'Especialización Tecnológica'), ('COM', 'Complementario')], max_length=3, verbose_name='Nivel de Formación')),
